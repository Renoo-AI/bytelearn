...
(function() {
    ...
    const ROOM_DATA = {
        en: {
            ...
            // World 1: PayPal
            w1l1:{title:"Amount Swap",desc:"The transfer amount is stored in a data attribute on the button. The display shows $5,000 — but what does the attribute say?",objective:"Change data-amount from 5000 to 0 or a negative number, then click Send."},
            w1l2:{title:"Currency Inject",desc:"Exchange rates are fixed in a dropdown. The dropdown is HTML — you can add your own options.",objective:"Right-click the currency select, edit as HTML, and inject an option with value='0'."},
            w1l3:{title:"Recipient Spoof",desc:"The recipient list has only 3 accounts. But the dropdown options are just DOM elements you can modify.",objective:"Edit the select HTML and add an option with value='hacker@evil.com', then send the money."},
            w1l4:{title:"Timestamp Bypass",desc:"The daily transfer limit uses the browser clock to determine when to reset. Spoof the client timestamp.",objective:"Change window.clientDate to tomorrow's date via the Console to reset the daily limit counter."},
            w1l5:{title:"Approval Override",desc:"Multi-signature approvals are stored in localStorage. Each signature is a boolean flag that can be toggled.",objective:"Set localStorage sig_cfo, sig_cto, and sig_ceo all to 'true' via the Console to bypass the approval chain."},
            // World 2: Netflix
        ...
        ar: {
            ...
            w1l1:{title:"تلاعب بالمبلغ",desc:"مبلغ التحويل مخزن في خاصية data-amount على الزر. الشاشة تظهر $5,000 ولكن ما القيمة الحقيقية؟",objective:"غير data-amount من 5000 إلى 0 أو رقم سالب، ثم انقر إرسال."},
            w1l2:{title:"حقن عملة",desc:"أسعار الصرف ثابتة في قائمة منسدلة. القائمة مجرد HTML يمكنك إضافة خياراتك الخاصة.",objective:"انقر يمينا على قائمة العملات، حرر كـ HTML، وأضف خيارا بقيمة '0'."},
            w1l3:{title:"انتحال المستلم",desc:"قائمة المستلمين تحتوي على 3 حسابات فقط. لكن خيارات القائمة مجرد عناصر DOM.",objective:"حرر HTML القائمة وأضف خيارا بقيمة 'hacker@evil.com'، ثم أرسل المال."},
            w1l4:{title:"تجاوز الطابع الزمني",desc:"حد التحويل اليومي يستخدم ساعة المتصفح لتحديد موعد إعادة التعيين. زور الطابع الزمني.",objective:"غير window.clientDate إلى تاريخ الغد عبر الكونسول لإعادة تعيين العداد اليومي."},
            w1l5:{title:"تجاوز الموافقات",desc:"موافقات التوقيع المتعدد مخزنة في localStorage. كل توقيع عبارة عن علامة منطقية يمكن تبديلها.",objective:"اجعل localStorage sig_cfo و sig_cto و sig_ceo كلها 'true' عبر الكونسول."},
